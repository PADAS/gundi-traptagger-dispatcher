...
@pytest.fixture
def cached_event():
    return '{"camera": "gundicam-test", "latitude": "-27.10443", "longitude": "-108.23966", "timestamp": "2025-03-05 12:18:30"}'
...
def event_v2_as_pubsub_request(mocker):
    ...
    json_data = {
        "message": {
            "data": "",  # pragma: allowlist secret
            "attributes": {
                "annotations": "{}",
                "data_provider_id": "b976ac0e-135a-4212-88b7-7bfc58e897a2",
                "destination_id": "a16f0110-bf40-4518-9c68-9018c6ec8f6d",
                "external_source_id": "gundicam-test",
                "gundi_id": "56a5afe0-7829-47d1-a496-80dcbf816593",
                "gundi_version": "v2",
                "provider_key": "gundi_wps_watch_r_b976ac0e-135a-4212-88b7-7bfc58e897a2",
                "related_to": "",
                "source_id": "7c251370-326f-40bf-917d-8b5a5134d130",
                "stream_type": "ev",
                "tracing_context": "{}",
            },
            "messageId": "14148171483832697",
            "message_id": "14148171483832697",
            "orderingKey": "",
...
def attachment_v2_as_pubsub_request(mocker):
    ...
    json_data = {
        "message": {
            ...
            "messageId": "14148756572947597",
            "message_id": "14148756572947597",
            "orderingKey": "",
            "publishTime": f"{publish_time}",
            "publish_time": f"{publish_time}",
        },
